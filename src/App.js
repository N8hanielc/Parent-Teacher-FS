...
class App extends React.Component {
  ...
  aucSchools = [
    ...
    '/images/Spelmanlogo.png',
    '/images/clarkLogo.png',
  ];

  nflTeams = ['/images/ravenslogo.png', '/images/chiefslogo.png'];

  bestNflTeam = [
    '/images/ravenslogo.png',
    '/images/patriotslogo.png',
    '/images/chiefslogo.jpeg',
  ];
